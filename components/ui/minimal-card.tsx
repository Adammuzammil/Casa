...
>(({ className, children, ...props }, ref) => (
  <div
    ...
    className={cn(
      "rounded-[24px] bg-neutral-100 p-2 no-underline shadow-sm transition-colors hover:bg-neutral-100 dark:bg-neutral-800 dark:hover:bg-neutral-800/80 ",
...
>(({ className, alt, src, ...props }, ref) => (
  ...
  >
    <Image
      ...
      width={200}
      height={200}
      className="absolute inset-0 size-full rounded-[16px] "
    />
